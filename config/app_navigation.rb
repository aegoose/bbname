...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.item :about, '关于我们',backend_root_path
    primary.item :solution, '解决方案',backend_root_path
    # primary.item :partner, '合作伙伴',partner_path
    primary.item :jobs, '招纳贤士',backend_root_path
  end
end
